...
import (
	...
	"github.com/nstoker/congenial-memory/todo"
)
...
// AddTodoHandler adds a new todo to the list
...
// DeleteTodoHandler deletes a todo from the list
...
// CompleteTodoHandler will mark a todo item as completed
